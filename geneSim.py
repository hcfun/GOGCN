...
#计算基因之间的相似度
    ...
    def calSimGenes_Allmethods(self):
        ...
        #计算相似度
        iea = open('./geneSim/{}/{}_iea_{}'.format(self.p.species, self.p.onto, self.p.genePair[-3:]), 'w')
        niea = open('./geneSim/{}/{}_niea_{}'.format(self.p.species, self.p.onto, self.p.genePair[-3:]), 'w')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-genePair', dest='genePair', default='./data/genePair/genePair_sgd_pathway', help='基因对')
    parser.add_argument('-ontology', dest='onto', default='mf', help='bp,cc,mf. 在三个不同的本体上计算相似度')
    parser.add_argument('-species', dest='species', default='pathway_sgd', help='dictory of storing the experimental results: human or sgd')
    parser.add_argument('-embed_dir', dest='embed_dir', default='./embedding/ent_embedding_Pretraining_75b2d53a.csv', help='分布式表示')
    parser.add_argument('-goa_dir', dest='goa_dir', default='./data/goa_sgd', help='goa文件')
